...
const FAQ = () => {
  ...
  const getData = ()=>{
    ...
    fetch(`${baseURL}faq?order=desc`, {method: 'GET', headers})
   ...
   const deleteItem = (id)=>{
    ...
    fetch(`${baseURL}faq/${id}`, {method: 'DELETE', headers})
    .then((response) => response.json())
    .then((responseJson) => {
      // console.log(responseJson);
        ...
        {/* Title End */}
          ...
          <Row>
            ...
            <Col xs="12" sm="auto" className="d-flex align-items-center justify-content-end">
              <NavLink to="/content/faq/add" className="btn btn-outline-primary btn-icon btn-icon-start ms-0 ms-sm-1 w-100 w-md-auto">
                      ...
                      <Card.Body className="d-flex flex-column p-0 pe-4 h-100 justify-content-center">
                        <div className="d-flex flex-column">
                          ...
                          <Row className=" alternate-link">
                            ...
                            <Col md="auto">
                              <Button onClick={()=> {history.push({pathname:"/content/faq/detail", state:{data:item}})}} className="btn btn-primary btn-icon btn-icon-start" >Edit</Button>
                            </Col>
            ...
            <Card className="mb-5">
              <Card.Body className="sh-50 d-flex align-items-center justify-content-center">
                <div className="text-center">
                  ...
                  <div className="cta-1">No FAQ found !</div>
                  <div className="cta-3 text-primary mb-4">Would you like to add faq?</div>

                   <NavLink to="/content/faq/add" variant="primary" className="btn btn-outline-primary btn-icon btn-icon-start ms-0 ms-sm-1 w-100 w-md-auto">
                      <CsLineIcons icon="plus" /> <span>Add New</span>
                   </NavLink>
