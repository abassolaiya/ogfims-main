...
const SendPushNotification = () => {
  const title = 'Send Push Notification';
  const description = '';
        ...
        <div className="page-title-container mb-3">
          <Row>
            <Col className="mb-2">
              ...
              <div className="text-muted font-heading text-small">Send Push Notification</div>
            </Col>
          </Row>
        </div>
        {/* Title End */}
        ...
        <Card className="mb-5">
          <Card.Body>
            <Form className="mb-n3">
              ...
              <div className="mb-3 filled">
                <CsLineIcons icon="bell" />
                <Form.Control type="text" as="textarea" rows={6} onChange={(e)=>{}}  />
              </div>
